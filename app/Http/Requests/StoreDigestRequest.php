...
class StoreDigestRequest extends FormRequest
{
    ...
    {
        $maxDigests = config('isir.limits.digests_per_user');

        if ($maxDigests === -1) {
            return true;
        }

        return $this->user()->digests()->count() < $maxDigests;
    }
    ...
    protected function failedAuthorization(): void
    {
        ...
        abort(403, "You have reached the maximum number of digests ({$maxDigests}).");
    }
